...
I was previously part of the development team at **BLOODSTONE LLC** (Russia).  
The work was internal, non-public, and not intended for showcasing.

My involvement focused on Lua-based solutions operating in hostile, unstable,  
and detection-aware environments where mistakes are expensive  
and undefined behavior is never theoretical.
...
it was whether the script remained predictable under pressure.
...
- **Discord** — [@tanaru](javascript:void(0))
